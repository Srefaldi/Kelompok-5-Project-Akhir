...
public class QuestionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(setNmae.equals("Quiz-1")){
            ...
            setFour();
        } else if (setNmae.equals("Quiz-5")) {
            setFive();
        } else if (setNmae.equals("Quiz-6")) {
            setSix();
        } else if (setNmae.equals("Quiz-7")) {
            setSeven();
        }
    ...
    private void setOne() {
        list.add(new QuestionModel("Kata Mikrotik merujuk pada bahasa Latvia tempat OS ini berasal, yang berarti...",
                "Internet","Alat Listrik", "Sistem Operasi","Network Kecil",
                "Network Kecil"));

        list.add(new QuestionModel("Salah satu tools Mikrotik adalah...",
                "Netbeans","Winbox", "visual studio code","Notepad",
                "Winbox"));

        list.add(new QuestionModel("Winbox menyediakan shortcut untuk?",
                "membantu memanajemen perangkat mikrotik","memudahkan memanajemen hp pengguna",
                "memudahkan server global","membayar pajak",
                "membantu memanajemen perangkat mikrotik"));

        list.add(new QuestionModel("Mikrotik Router OS menawarkan beberapa kemudahan, Kecuali?",
                "kemudahan implementasi","kemudahan konfigurasi", "kemudahan dalam integrasi dengan perangkat lain","kemudahan untuk berkomunikasi dengan tetangga",
                "kemudahan untuk berkomunikasi dengan tetangga"));

        list.add(new QuestionModel("Apa visi dari adanya mikrotik?",
                "memudahkan manajemen networking","memudahkan manajemen uang", "mempercepat akses ke hp pengguna","mempersulit wifi",
                "memudahkan manajemen networking"));
    }
    private void setTwo() {
